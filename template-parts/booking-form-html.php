        ...
        <div class="col-md-8">
            <form method="">
                <div class="form-group mb-4">
                    ...
                    <input disabled type="text" class="form-control p-3" id="locatie" placeholder="Locatie" value="<?php echo $location_post_title; ?>" required>
                </div>
                <div class="form-group mb-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="number" class="form-control p-3" id="totalbedrag" placeholder="€" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-4">
